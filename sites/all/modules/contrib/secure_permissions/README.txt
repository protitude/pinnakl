// $Id: README.txt,v 1.4 2010/12/31 22:55:14 agentken Exp $
...
code via the API.
  ...
  NOTE that none of the following settings will be in effect if 'Load permissions
...
This module was written for Drupal 7. It should be backported to Drupal 6, using
the Permissions API module.

http://drupal.org/projet/permissions_api
